...
export default {
  ...
  authRole: {
    title: 'Auth Role Permissions',
    roleList: 'Auth Roles',
    roleSearchPlaceholder: 'Search role name or key',
    permissionConfig: 'Permission Config',
    permissionWorkbench: 'Permission Workbench',
    filterHint: 'Find permissions by name, key, or type, and review the checked state directly in each node card.',
    tableHint: 'Use a hierarchical table for permissions so future action columns, sort data, and extra metadata fit more naturally.',
    permissionSearchPlaceholder: 'Search permission name or key',
    permissionName: 'Permission Name',
    permissionKeyLabel: 'Permission Key',
    permissionType: 'Permission Type',
    allTypes: 'All Types',
    onlyChecked: 'Checked Only',
    selectedPermissions: 'Checked',
    visiblePermissions: 'Visible',
  ...
  role: {
    ...
    // MCP Tools
    mcpTools: 'MCP Tools',
    mcpSelectTools: 'Select MCP tools',
    mcpSaveFailed: 'Failed to save tool selection',
    mcpLoadToolsFailed: 'Failed to load MCP tools',
